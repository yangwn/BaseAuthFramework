package com.cfilmcloud.cas.authentication;
...
public class ValidUserQueryDBAuthenticationHandler extends AbstractJdbcUsernamePasswordAuthenticationHandler {
	...
	private static final String DEFAULT_LOCKED_FIELD = "is_lock";
	private static final String DEFAULT_DISABLED_FIELD = "is_delete";
	/**
	 * The Algorithm name.
	 */
	@NotNull
	...
	protected String digestEncodedPassword(final String encodedPassword, final Map<String, Object> values) {
		...
		final HashRequest request = new HashRequest.Builder().setSource(encodedPassword).build();
